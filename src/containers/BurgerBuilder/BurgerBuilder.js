...
class BurgerBuilder extends Component{
        ...
        return (
          <React.Fragment>
             ...
             <Burger ingredients={this.state.ingredients}  />
              <BuildControls addIngredient={this.addIngredientHandler} disabled={disabled}
    ...
    addIngredientHandler = (type) =>{
        ...
        const newState = {ingredients: newIngredients, totalPrice: this.calculatePrice(newIngredients)};
